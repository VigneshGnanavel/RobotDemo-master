        ...
        stage('Xray Import') {
            steps {
                script {
                    ...
                    def issueKey = "TA-8"
                    def jiraUrl = "https://gnanavelvignesh124.atlassian.net/projects/TA?selectedItem=com.atlassian.plugins.atlassian-connect-plugin:com.xpandit.plugins.xray__testing-board#!page=test-execution-board&testExecutionId=10007&testPlanId=Import+Execution+Results}"
